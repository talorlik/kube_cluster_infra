...
### Secrets ###
sub_domain_cert_body_secret_name = "sub-domain/certificate-body/v5c"
sub_domain_cert_key_secret_name  = "sub-domain/certificate-key/v5c"
join_secret_name                 = "kubeadm/join-details/v5c"
kube_config_secret_name          = "kube/config/v5c"
kube_dashboard_token_secret_name = "kube/dashboard-token/v5c"
### ECR ###
