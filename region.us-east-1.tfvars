...
### Secrets ###
sub_domain_cert_body_secret_name = "sub-domain/certificate-body/v3"
sub_domain_cert_key_secret_name  = "sub-domain/certificate-key/v3"
join_secret_name                 = "kubeadm/join-details/v3"
kube_config_secret_name          = "kube/config/v3"
kube_dashboard_token_secret_name = "kube/dashboard-token/v3"
### ECR ###
