...
### Secrets ###
sub_domain_cert_body_secret_name = "sub-domain/certificate-body/v8a"
sub_domain_cert_key_secret_name  = "sub-domain/certificate-key/v8a"
join_secret_name                 = "kubeadm/join-details/v8a"
kube_config_secret_name          = "kube/config/v8a"
kube_dashboard_token_secret_name = "kube/dashboard-token/v8a"
### ECR ###
