...
### Secrets ###
sub_domain_cert_body_secret_name = "sub-domain/certificate-body/v4a"
sub_domain_cert_key_secret_name  = "sub-domain/certificate-key/v4a"
join_secret_name                 = "kubeadm/join-details/v4a"
kube_config_secret_name          = "kube/config/v4a"
kube_dashboard_token_secret_name = "kube/dashboard-token/v4a"
### ECR ###
