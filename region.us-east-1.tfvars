...
### Secrets ###
sub_domain_cert_body_secret_name = "sub-domain/certificate-body/v2d"
sub_domain_cert_key_secret_name  = "sub-domain/certificate-key/v2d"
join_secret_name                 = "kubeadm/join-details/v2d"
kube_config_secret_name          = "kube/config/v2d"
kube_dashboard_token_secret_name = "kube/dashboard-token/v2d"
### ECR ###
