...
### Secrets ###
sub_domain_cert_body_secret_name = "sub-domain/certificate-body/v3d"
sub_domain_cert_key_secret_name  = "sub-domain/certificate-key/v3d"
join_secret_name                 = "kubeadm/join-details/v3d"
kube_config_secret_name          = "kube/config/v3d"
kube_dashboard_token_secret_name = "kube/dashboard-token/v3d"
### ECR ###
